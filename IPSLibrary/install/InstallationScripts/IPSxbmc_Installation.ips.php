...
//	CreateProfile_Switch ('IPSSonos_Busy',            'Bereit', 'Aktiv', "", -1, 0x0000ff);
	...
	$id_IPSSonosServerId = CreateDummyInstance("IPSxbmc_Server", $CategoryIdData, 10);
...
//	$id_Port             = CreateVariable(IPSSONOS_VAR_PORTID,          1 /*Integer*/, $id_IPSSonosServerId, 300, '',                      null,              0,     '');
	$id_RoomIds          = CreateVariable(IPSxbmc_VAR_ROOMIDS,         3 /*String*/,  $id_IPSxbmcServerId, 310, '',                      null,              '',    '');
	$id_RoomCount        = CreateVariable(IPSxbmc_VAR_ROOMCOUNT,       1 /*Integer*/, $id_IPSxbmcServerId, 320, '',                      null,              0,     '');
	$id_IPAddr        	 = CreateVariable(IPSxbmc_VAR_IPADDR,       	3 /*String*/,  $id_IPSxbmcServerId, 400, '',               	   null,              '',    '');
...
//	}
	...
	// ===================================================================================================
		...
		foreach ($RoomConfig as $GroupName=>$GroupData) {
			...
			$PowerId        	= CreateVariable(IPSxbmc_VAR_ROOMPOWER,   0 /*Boolean*/, $RoomInstanceId,  10, '~Switch',              $id_ScriptSettings, IPSSONOS_VAL_POWER_DEFAULT, 'Power');
...
//			$GainId         	= CreateVariable(IPSSONOS_VAR_INPUTGAIN,   1 /*Integer*/, $RoomInstanceId,  30, 'IPSSonos_InputGain',   $id_ScriptSettings, IPSSONOS_VAL_INPUTGAIN_DEFAULT, 'Lightning');
			$VolumeId      	= CreateVariable(IPSxbmc_VAR_VOLUME,      1 /*Integer*/, $RoomInstanceId,  40, 'IPSSonos_Volume',      $id_ScriptSettings, IPSSONOS_VAL_VOLUME_DEFAULT, 'Intensity');
			$MutingId       	= CreateVariable(IPSxbmc_VAR_MUTE,        0 /*Boolean*/, $RoomInstanceId,  50, 'IPSSonos_Mute',        $id_ScriptSettings, IPSSONOS_VAL_MUTE_DEFAULT, 'Speaker');
			$TransportId    	= CreateVariable(IPSxbmc_VAR_TRANSPORT,   1 /*Integer*/, $RoomInstanceId,  60, 'IPSSonos_Transport',   $id_ScriptSettings, IPSSONOS_VAL_TRANSPORT, 'Speaker');
