<?php 
	 ...
	 * @{
	 *
	 * @file          IPSSonosPlayer_MP3Control.php
...
<html>
	...
	<?
//		IPSUtils_Include ("IPSSonosPlayer.inc.php", "IPSLibrary::app::modules::NetPlayer");
		include_once "IPSSonos_Sender.php";
		include_once "IPSSonos_Utils.php";
	?>
	<script>
